                            ...
                            <form class="form" method="POST" action="{{ route('product.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" placeholder="Product Name" name="name" value="{{ old('name') }}" class="form-control form-control-success">
                                        @if ($errors->has('name'))
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <select name="category" id="category" class="form-control" onchange="getSubctegories()">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="number" placeholder="Price" name="price" min="0" value="{{ old('price') }}" class="form-control form-control-success">
                                                @if ($errors->has('price'))
                                                    <div class="text-danger">
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        <input type="number" id="qty" name="qty" min="0" class="form-control" value="{{old('qty') }}">
                                    </div>
                                    <!-- Rounded switch -->
                                    <div class="col-lg-2" style="margin-top: 4%;">
                                        <div class="i-checks">
                                            <input type="checkbox" class="checkbox-template" value="1" name="featured" @if(old('featured')) checked @endif>
...
<!-- Summernote-->
    ...
    <script src="{{ asset('/admin/js/components-preloader.js') }}"></script>
    <script>
        ...
        function getSubctegories() {
            ...
            fetch(url).then( (response) => {
                ...
                data.map(function(s) {
                    ...
                    appendToTag('subcategory', countryElement);
